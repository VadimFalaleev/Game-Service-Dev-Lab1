...
-Я создал 3D проект в Unity версии 2022.1.0f1.
...
-объекту Cube добавил компонент Rigidbody и поставил галочку напротив Use Gravity, чтобы объект падал на Plane, но не проваливался сквозь него.
